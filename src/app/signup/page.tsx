                ...
                <div className="bg-white dark:bg-gray-800 py-8 px-4 shadow-lg sm:rounded-lg sm:px-10 border border-gray-200 dark:border-gray-700">
                    <form method="POST" onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-6">
                        ...
                        <div>
                            ...
                            {errors.passwordConfirm && <p className="mt-2 text-sm text-red-600 dark:text-red-500">{errors.passwordConfirm.message}</p>}
                        </div>
                        ...
                        <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg border border-gray-200 dark:border-gray-600">
                            <div className="flex items-start mb-2">
                                <div className="flex items-center h-5">
                                    <input
                                        ...
                                        className={`w-4 h-4 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 ${
                                            checkboxDisabled
                            ...
                            <div className="flex flex-col sm:flex-row gap-2 mt-3">
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center px-3 py-2 text-sm border ${
                                        privacyRead
